...
firebase.initializeApp({
    apiKey: "AIzaSyAyRDpZbMxSi1Frg_uKIl5gkUCr9qRYBHM",
    authDomain: "chat-drag.firebaseapp.com",
    projectId: "chat-drag",
    storageBucket: "chat-drag.appspot.com",
    messagingSenderId: "539983198631",
    appId: "1:539983198631:web:f0a1a91cb5036940f1de82",
    measurementId: "G-B5EBXKW1H2"
});
...
function App() {
    ...
    return ( <
        ...
        <
        header className = "flex-shrink-0 flex items-center justify-between px-4 sm:px-8 shadow-md"
        style = {
        ...
        ThemeIcon className = "h-8 w-8 cursor-pointer"
        onClick = {
